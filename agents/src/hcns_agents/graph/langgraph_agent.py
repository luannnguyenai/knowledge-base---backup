...
class LangGraphAgent:
    ...
    def _classify_with_llm(self, question: str) -> str:
        ...
        from hcns_shared.types import Chunk as _Chunk, ScoredChunk as _SC
...
def build_langgraph_from_config(config: "BenchmarkConfig") -> LangGraphAgent:  # type: ignore[name-defined]
    ...
    import hcns_backend  # noqa: F401
    import hcns_agents.generators  # noqa: F401

    from hcns_shared.config import BenchmarkConfig
    from hcns_agents.pipelines.static_pipeline import _build_generator
