...
from hcns_agents.prompts import load_prompt

# Loaded lazily from prompts/gemini_system.md (prompts are not embedded in code)
_GEMINI_SYSTEM_PROMPT = load_prompt("gemini_system")
